...
| :-----: | :----------------------------------------------------------: | :---------------------------------------------------------- | :------------------------- |
|    1    | 第1章 操作系统引论1.1-1.7节 <br />[第1章思维导图](/courses/OperatingSystem/mindmap/chapter1.png) | 操作系统的目标和作用、操作系统的发展过程、操作系统的基本特性、操作系统的主要功能、操作系统的结构设计 <br /> [我看三分钟:](https://www.bilibili.com/video/BV1n4411178U/?p=2&spm_id_from=333.337.top_right_bar_window_history.content.click&vd_source=38e6ecf5920cd9040a4af26969a2d4f6) |        第1章作业，课后1，2，25                     |
|    2    | 第2章 进程描述与控制 2.1-2.3，2.4-2.6（2次课）<br />[第2章思维导图](/courses/OperatingSystem/mindmap/chapter2.png) |      前趋图、进程的描述、控制、通信、线程、讲解作业 <br /> <font color="blue">提前预习内容：</font>程序并发执行P5-7、进程控制P24-28、线程的实现P45-51    <br /> [我看三分钟:并行并发](https://pan.baidu.com/s/1Dc18ZVn_ld0CFwp2C8O2gA?pwd=nwnu)，[我看三分钟:进程的状态](https://pan.baidu.com/s/1OJZ9Wh55pk9Y-425DDvsxw?pwd=6efr)，[我看三分钟:为什么需要线程](https://www.bilibili.com/video/BV1eCz6YVEAb/?vd_source=38e6ecf5920cd9040a4af26969a2d4f6)          |   第2章作业，1，2，21   |
|    3    | 第3章 处理机调度与死锁3.1-3.2<br />[第3章思维导图](/courses/OperatingSystem/mindmap/chapter3.png) |          处理机调度概述，调度算法<br /> <font color="blue">提前预习内容：</font>评价指标P11、优先级调度算法P21-24， 高响应比优先调度P25    <br /> [我看三分钟:调度算法](https://pan.baidu.com/s/199AL_cZgHEKBE5UqS-1nkw?pwd=7nrj)      |       |
