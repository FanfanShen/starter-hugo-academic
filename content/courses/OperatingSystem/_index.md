...
|    10    | 第6章 虚拟存储器6.4-6.6，7.1；第7章 输入输出系统7.2-7.5 |  抖动与工作集、请求分段存储管理方式、虚拟存储器实现实例、；  <br /> <font color="blue">提前预习内容：</font> <br />第5章作业，抖动的预防方法P35，分段的共享P39，IO软件的层次结构P6；IO通道P21、中断处理程序P31、设备驱动程序框架P36、设备分片P41-42       |      |
