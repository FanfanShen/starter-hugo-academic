...
|    2    | 第2章 进程描述与控制 2.1-2.3，2.4-2.6<br />[第2章思维导图](/courses/OperatingSystem/mindmap/chapter2.png) |      前趋图、进程的描述、控制、通信、线程、讲解作业 <br /> **学生讲解内容：**程序并发执行P5-7、进程控制P24-28、线程的实现P45-51               |   第2章作业，1，2，21   |
|    3    | 第3章 处理机调度与死锁3.1-3.2<br />[第3章思维导图](/courses/OperatingSystem/mindmap/chapter3.png) |          处理机调度概述，调度算法<br /> **学生讲解内容：**评价指标P11、优先级调度算法P21-24， 高响应比优先调度P25         |       |
