...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        - 本课题组以分布式机器学习为核心研究方向，聚焦多模态数据处理中的算法性能、数据安全、隐私保护及知识缓存等关键问题，涉及深度学习、分布式机器学习、联邦学习、模型轻量化、知识蒸馏、加密技术、机器视觉等技术，旨在构建安全高效、轻量化可部署的分布式智能系统，研究可应用于推荐系统、大规模多模态数据处理、搜索引擎、智慧医疗、自动驾驶、金融风控等实际场景。
